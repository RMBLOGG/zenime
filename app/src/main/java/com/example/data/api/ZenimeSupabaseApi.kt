...
interface ZenimeSupabaseApi {
    ...
    suspend fun getChatMessages(
        @Query("select") select: String = "id,firebase_uid,username,avatar_url,message,created_at,reply_to_id,reply_to_username,reply_to_message,message_type,audio_url,duration_seconds,waveform",
